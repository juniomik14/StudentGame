jQuery("#simulation")
  .on("click", ".s-302babc1-1c54-4ae5-9a19-f0f9e7abdbcc .click", function(event, data) {
  ...
  .on("pageload", ".s-302babc1-1c54-4ae5-9a19-f0f9e7abdbcc .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-line-grey")) {
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-line-grey_4")) {
      cases = [
        {
          "blocks": [
            {
  ...
  .on("variablechange.jim", ".s-302babc1-1c54-4ae5-9a19-f0f9e7abdbcc .variablechange", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
